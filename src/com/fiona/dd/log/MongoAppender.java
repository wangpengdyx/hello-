 ...
 * <appender name="mongodb" class="com.fiona.dd.log.MongoAppender">
 *       <facility>logback-mongo-test</facility>
 *       <mongoHost>127.0.0.1</mongoHost>
 *       <mongoPort>27017</mongoPort>
 *       <databaseName>test</databaseName>
 *       <collectionName>logs</collectionName>
 *       <safeInsert>false</safeInsert> <!-- by default, it's false -->
 *   </appender>
 */
public class MongoAppender<E> extends AppenderBase<E>{
	...
	private void initExecutor() {
        try {
            ...
            MongoConverter<E> converter = new MongoConverter<E>(facility, additionalFields, hostname);
